            ...
            <div className="lg:col-span-7 p-5 sm:p-8 md:p-10 space-y-6 sm:space-y-8 flex flex-col justify-between">
              ...
              <form onSubmit={handleAddToCart} className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-amber-500/10 via-amber-400/10 to-amber-500/20 border-2 border-amber-400/90 rounded-2xl p-5 shadow-md relative space-y-3">
                  ...
                  <div>
                    <label htmlFor="businessName" className="text-sm sm:text-base font-black text-slate-950 block mb-1">
                    ...
                    <p className="text-xs text-slate-600 mb-2.5 font-medium leading-snug">
                      Escribe aquí el nombre de tu local o empresa. Lo programamos de fábrica en tu chip NFC.
                    </p>
