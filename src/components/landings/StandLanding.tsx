...
import { Star, CheckCircle2, ChevronDown, ChevronUp, ArrowRight, ShieldCheck, Zap, Upload, QrCode, Image as ImageIcon } from 'lucide-react';
              ...
              <form onSubmit={handleAddToCart} className="space-y-6">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 space-y-1.5">
                  ...
                  <p className="text-[11px] text-amber-800 leading-relaxed">
                    Tu Stand llega listo y pre-programado. En tu primer toque lo vinculas a tu negocio en 30 segundos sin necesidad de ingresar URLs previas.
                  </p>
                </div>
                  ...
                  <div className={`border rounded-xl p-4 transition-all ${hasCustomLogo ? 'border-brand-950 bg-brand-50/50' : 'border-brand-200 bg-white'}`}>
                    <label className="flex items-start space-x-3 cursor-pointer">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[11px] text-brand-500 mt-0.5">Grabado láser de tu logo oficial en el Stand.</p>
                      </div>
                    </label>
