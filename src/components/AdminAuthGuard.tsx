    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 text-slate-100 font-sans">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-black text-white">starTAP Panamá Admin Master</h1>
          <p className="text-xs text-slate-400">Acceso exclusivo reservado para el Administrador Principal.</p>
        </div>
        ...
        <form onSubmit={handleAdminLogin} className="space-y-4">
          ...
          >
            {authLoading ? 'Verificando...' : 'Iniciar Sesión Admin Master'}
          </button>
        </form>

        <div className="relative flex items-center justify-center my-2">
          <div className="border-t border-slate-800 w-full"></div>
          <span className="bg-slate-900 px-3 text-[10px] text-slate-500 uppercase font-bold tracking-wider">o</span>
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs rounded-xl border border-slate-700 transition flex items-center justify-center gap-2"
        >
